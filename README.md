About terraform-provider-oci-feedstock
======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-oci-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-oci-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-oci
# for installing globally
pixi global install terraform-provider-oci
```
...
It is possible to list all of the versions of `terraform-provider-oci` available on your platform:
...
```
pixi search terraform-provider-oci --channel conda-forge
```
